...
piston.create = function(config){
    ...
    var server_socket = context.createSocket("pull");
    server_socket.connect(options.listening_endpoint);

    var result_socket = context.createSocket("push");
    result_socket.connect("ipc://results-"+options.cylinder_id+".ipc");
...
piston.sandboxGenerator = require("./piston/sandbox_generator").sandboxGenerator;
piston.server = require("./piston/piston_server").pistonServer;
