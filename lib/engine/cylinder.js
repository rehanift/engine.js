...
var log_message = require("./logger/log_message").log_message;
var loggable = require("../mixins/loggable").loggable;
...
cylinder.create = function(config){
    var logging_gateway = cylinder.find_or_create_logging_gateway(config);
    ...
    var spawner = process_spawner.create({
        file: path.dirname(require.resolve("engine.js")) + "/script/piston.js",
