...
TaskResponse.prototype.isExecutionError = function(){
  return typeof(this.params.error) != "undefined";
};

TaskResponse.prototype.getExecutionError = function(){
  return this.params.error;
}

TaskResponse.prototype.getDebug = function(){
  return this.params.response.debug || [];
};
