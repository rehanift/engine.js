...
var mockCylinder = function(options){
  ...
  self.addSocket("combustion", options.combustionSocket);  
...
describe("Piston", function(){
  ...
  beforeEach(function(){
    ...
    var combustionSocket = context.createSocket("req");
    combustionSocket.connect(PISTON_ENDPOINT);

    var socketOptions = {
      combustionSocket: combustionSocket
    };

    myCylinder = new mockCylinder(socketOptions);
